...
font-size: 24px;
 ...
 <form action="../php/user-form-add.php" id="user_details" method="post">
 ...
 <legend><b>User Details</b></legend>
  ...
  <table class="center">
	<tbody><tr>
		...
		<td class="field2"><input type="text" maxlength="19" name="UserID"></td>
		<td class="field1"><div class="div-cont2">Full Name</div></td>
		<td class="field2"><input type="text" maxlength="19" name="FullName"></td>
	</tr>
  
  	<tr>
		<td class="field1"><div class="div-cont2">Contact Number</div></td>
		<td class="field2"><input type="text" maxlength="19" name="ContactNumb"></td>
		<td class="field1"><div class="div-cont2">Email Address<div></div></div></td>
		<td class="field2"><input type="text" maxlength="19" name="EmailAdds"></td>
	</tr>
  
  	<tr>
		<td class="field1"><div class="div-cont2">ID Status</div></td>
		<td class="field2"><div class="div-cont1"></div></td>
  	...
  	<tr>
		...
		<td class="field2" colspan="3">
			<div class=""><textarea cols="120" rows="5" name="Remarks"></textarea></div>
		</td>
	</tr>
