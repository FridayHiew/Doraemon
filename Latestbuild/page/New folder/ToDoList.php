...
<div class="topnav-2">
  <a class="active" href="ToDoList.php">Draft</a>
...
<div class="div-head1"><b>To-Do List - Draft</b></div>
<hr class="div-head1">
...
$sql = "SELECT * FROM dora_temp_user where RequestStatus='draft'";
?>
...
<?php
    ...
    if(!empty($_REQUEST['selection1'])) {
		    ...
		    if(!empty($_REQUEST['selection2'])) {
				...
				$sql = "SELECT * FROM dora_temp_user where $selected LIKE '%" . $firstname ."%' AND RequestStatus='draft'";
			} else {
