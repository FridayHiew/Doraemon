...
<table class="center">
		...
		<tr>
			<th colspan="7">Please enter at least one of the following criteria.</th>
		</tr>
		...
		<tr>
				...
				<td style="width:20%"><div class="div-search1">User ID</div></td>
				<td style="width:25%"><input type="text"></input><button>Search</button></td>
				<td style="width:10%"></td>
				<td style="width:20%"><div class="div-search1">Full Name</div></td>
				<td style="width:25%"><input type="text"></input><button>Search</button></td>
		...
		<tr>
				<td><div class="div-search1">Role</div></td>
				<td>
						<Select>
				...
				<td><div class="div-search1">FAP</div></td>
				<td>
						<Select>
						<option>Please Select</option>
						</select><button>Search</button>				
...
<!-- listing -->
		...
		<div>
			<button class="button1" onclick="window.location.href='AddUser.php';">Add</button>
		</div>
...
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
            ...
            echo '<tr>';
                ...
                echo '<th style="width:20%;">User ID</th>';
                echo '<th style="width:20%;">Full Name</th>';
				echo '<th style="width:20%;">Last Update Date</th>';
