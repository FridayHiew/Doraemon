...
?>
 ...
 <form action="../php/user-form-pending.php" id="user_details" method="post">
...
?>		
		  ...
		  <table class="center">
			<tbody><tr>
				...
				<td class="field2"><input readonly type="text" maxlength="19" name="FullName" value="<?php echo $data['FullName'] ?>" ></td>
			</tr>
		  
			<tr>
				<td class="field1"><div class="div-cont2">Contact Number</div></td>
				<td class="field2"><input readonly type="text" maxlength="19" name="ContactNumb" value="<?php echo $data['Contact'] ?>" ></td>
				<td class="field1"><div class="div-cont2">Email Address<div></div></div></td>
				<td class="field2"><input readonly type="text" maxlength="19" name="EmailAdds" value="<?php echo $data['Email'] ?>" ></td>
			</tr>
		  
			<tr>
				<td class="field1"><div class="div-cont2">Access Right</div></td>
				<td class="field2"><input readonly type="text" maxlength="19" name="AccessRight" value="<?php echo $data['Access'] ?>" ></td>
				<td class="field2"><input hidden type="text" maxlength="19" name="type" value="<?php echo $data['Request'] ?>" ></td>	
			</tr>
			...
			<tr>
				...
				<td class="field2" colspan="3">
					<div class=""><textarea readonly cols="120" rows="5" name="Remarks"><?php echo $data['Remarks'] ?></textarea></div>
				</td>
			</tr>
