...
$username1=$_GET['id'];
$sql = "SELECT * from dora_users where username='$username1'";
?>


			

 <form action="../php/user-form-update.php" id="user_details" method="post">
...
?>		
		  ...
		  <table class="center">
			...
			<tr>
				...
				<td class="field2"><input  type="text" maxlength="19" name="ContactNumb" value="<?php echo $data['Contact'] ?>" >				
				</td>
	...
	<tr>
				<td class="field1"><div class="div-cont2">Status</div></td>
				<td class="field2"><input readonly type="text" maxlength="19" name="Status" value="<?php echo $data['Status'] ?>" >
																	
				
								<?php
					if($data['Status']=="Active"){
						echo '	 <button name="submit" value="locked">Lock</button>';				
					}
					
					else {
						
						 echo '<button name="submit" value="unlock">Unlock</button>';
...
<div style="padding:30px;"></div>
 ...
 <div class="action2">	 
	 ...
	 <button name="submit" value="remove">Remove</button>
